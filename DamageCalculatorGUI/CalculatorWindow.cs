...
namespace DamageCalculatorGUI
{
    public partial class CalculatorWindow : Form
    {
            ...
            foreach (int errorCode in ex.Data.Keys)
            {
                switch (errorCode)
                {
                    ...
                    case 106: // Push
                        ...
                        break;
                    case 201: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorAttackBonusToHitTextBox, "No bonus to-hit provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorAttackBonusToHitTextBox, -18);
                        break;
                    case 202: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorAttackCriticalHitMinimumTextBox, "No crit at/below provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorAttackCriticalHitMinimumTextBox, -18);
                        break;
                    case 203: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorAttackACTextBox, "No AC provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorAttackACTextBox, -18);
                        break;
                    case 204: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorAttackMAPModifierTextBox, "No MAP provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorAttackMAPModifierTextBox, -18);
                        break;
                    case 205: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorAmmunitionReloadTextBox, "No reload provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorAmmunitionReloadTextBox, -18);
                        break;
                    case 206: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorAmmunitionMagazineSizeTextBox, "No magazine size provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorAmmunitionMagazineSizeTextBox, -18);
                        break;
                    case 207: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorAmmunitionLongReloadTextBox, "No long reload provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorAmmunitionLongReloadTextBox, -18);
                        break;
                    case 208: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorAmmunitionDrawLengthTextBox, "No draw length provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorAmmunitionDrawLengthTextBox, -18);
                        break;
                    case 209: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorReachRangeIncrementTextBox, "No range increment provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorReachRangeIncrementTextBox, -18);
                        break;
                    case 210: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorReachVolleyIncrementTextBox, "No volley increment provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorReachVolleyIncrementTextBox, -18);
                        break;
                    case 211: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorEncounterNumberOfEncountersTextBox, "Number of encounters not provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorEncounterNumberOfEncountersTextBox, -18);
                        break;
                    case 212: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorEncounterRoundsPerEncounterTextBox, "No rounds per encounter provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorEncounterRoundsPerEncounterTextBox, -18);
                        break;
                    case 213: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorActionActionsPerRoundTextBox, "No actions per round provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorActionActionsPerRoundTextBox, -18);
                        break;
                    case 214: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorDistanceEngagementRangeTextBox, "No engagement range provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorDistanceEngagementRangeTextBox, -18);
                        break;
                    case 215: // Push
                        CalculatorAttackErrorProvider.SetError(CalculatorReachMovementSpeedTextBox, "No movement speed provided!");
                        CalculatorAttackErrorProvider.SetIconPadding(CalculatorReachMovementSpeedTextBox, -18);
                        break;
                }
            }
        ...
        private void CalculateDamageStatsButton_MouseClick(object sender, MouseEventArgs e)
        {
            if (!HelperFunctions.IsControlDown())
            {
                ...
                { // Check for exception
                    ...
                    damageStats = CalculateAverageDamage(number_of_encounters: currEncounterSettings.number_of_encounters,
